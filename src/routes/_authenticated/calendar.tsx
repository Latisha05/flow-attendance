...
import { getAttendanceMonth } from "@/lib/api/attendance.functions";
...
function CalendarPage() {
  ...
  const fetchMonth = useServerFn(getAttendanceMonth);
  const { data } = useQuery({
    queryKey: ["attendance-month", cursor.y, cursor.m],
    queryFn: () => fetchMonth({ data: { year: cursor.y, month: cursor.m } }),
  });
